...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "tr": {
        ...
        "status_found": "Yüklü başlatıcılarda {count} oyun bulundu.",
        "empty_title": "Bir Oyun Seçin",
        "empty_desc": "Uyumluluğu görmek, hook yöntemlerini yapılandırmak ve tek tıkla DLSS Enabler kurmak için soldaki listeden bir oyun seçin.",
